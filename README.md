...
## 💡 Key Takeaway
This project provided hands-on experience with *SIEM (Sentinel)* and *Log Analysis (KQL)*, demonstrating how quickly vulnerable assets are discovered on the public internet.
